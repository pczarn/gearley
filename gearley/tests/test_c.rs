...
const SYM_NAMES: [Option<&'static str>; 176] = [
    ...
    Some("argument_expression_list_opt"),
    Some("argument_expression_list"),
    Some("unary_expression"),
    Some("unary_operator"),
    Some("cast_expression"),
    Some("multiplicative_expression"),
    Some("additive_expression"),
    Some("shift_expression"),
    Some("relational_expression"),
    Some("equality_expression"),
    Some("AND_expression"),
    Some("exclusive_OR_expression"),
    Some("inclusive_OR_expression"),
    Some("logical_AND_expression"),
    Some("logical_OR_expression"),
    Some("conditional_expression"),
    Some("assignment_expression"),
    Some("assignment_operator"),
    Some("expression"),
    Some("constant_expression"),
    Some("declaration"),
    Some("init_declarator_list_opt"),
    Some("declaration_specifiers"),
    Some("declaration_specifiers_opt"),
    Some("init_declarator_list"),
    Some("init_declarator"),
    Some("storage_class_specifier"),
    Some("type_specifier"),
    Some("struct_or_union_specifier"),
    Some("identifier_opt"),
    Some("struct_or_union"),
    Some("struct_declaration_list"),
    Some("struct_declaration"),
    Some("specifier_qualifier_list"),
    Some("specifier_qualifier_list_opt"),
    Some("struct_declarator_list"),
    Some("struct_declarator"),
    Some("declarator_opt"),
    Some("enum_specifier"),
    Some("enumerator_list"),
    Some("enumerator"),
    Some("type_qualifier"),
    Some("function_specifier"),
    Some("declarator"),
    Some("pointer_opt"),
    Some("direct_declarator"),
    Some("type_qualifier_list_opt"),
    Some("identifier_list_opt"),
    Some("pointer"),
    Some("type_qualifier_list"),
    Some("parameter_type_list"),
    Some("parameter_list"),
    Some("parameter_declaration"),
    Some("abstract_declarator_opt"),
    Some("identifier_list"),
    Some("abstract_declarator"),
    Some("direct_abstract_declarator"),
    Some("direct_abstract_declarator_opt"),
    Some("assignment_expression_opt"),
    Some("parameter_type_list_opt"),
    Some("typedef_name"),
    Some("initializer"),
    Some("initializer_list"),
    Some("designation_opt"),
    Some("designation"),
    Some("designator_list"),
    Some("designator"),
    Some("statement"),
    Some("labeled_statement"),
    Some("compound_statement"),
    Some("block_item_list_opt"),
    Some("block_item_list"),
    Some("block_item"),
    Some("expression_statement"),
    Some("expression_opt"),
    Some("selection_statement"),
    Some("iteration_statement"),
    Some("jump_statement"),
    Some("translation_unit"),
    Some("external_declaration"),
    Some("function_definition"),
    Some("declaration_list_opt"),
    Some("declaration_list"),
    Some("enumeration_constant"),
    Some("type_name"),
    Some("error"),
];
...
fn test_parse_c() {
    ...
    let mut grammar = Cfg::new();
    let [_term, identifier, signed, const_, inline, _auto, break_, case, char_, continue_, default, do_, double, else_, enum_, extern_, float, for_, goto, if_, int, long, register, return_, short, sizeof_, static_, struct_, switch, typedef, union, unsigned, void, volatile, while_, constant, string_literal, right_assign, left_assign, add_assign, sub_assign, mul_assign, div_assign, mod_assign, and_assign, xor_assign, or_assign, right_op, left_op, inc_op, dec_op, ptr_op, and_op, or_op, le_op, ge_op, eq_op, ne_op, elipsis, restrict, bool_, complex, imaginary, lparen, rparen, lbracket, rbracket, lbrace, rbrace, dot, colon, semicolon, comma, ampersand, star, plus, minus, tilde, exclamation, slash, percent, langle, rangle, xor, pipe, question, equal] =
        grammar.sym();
