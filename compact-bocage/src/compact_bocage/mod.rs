...
use crate::recognizer::item::CompletedItem;

use self::node::Node::*;
use self::node::{Graph, Node, NULL_ACTION};
use self::order::Order;

const DEFAULT_GRAPH_CAPACITY: usize = 1024;
const DEFAULT_DFS_CAPACITY: usize = 32;
    ...
    G: Grammar,
{
    pub fn new(grammar: G) -> Self {
        Self::with_capacities(grammar, DEFAULT_GRAPH_CAPACITY, DEFAULT_DFS_CAPACITY)
    }
