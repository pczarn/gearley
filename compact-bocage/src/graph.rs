...
impl Graph {
    ...
    pub fn push(&mut self, node: Node) {
        ...
        main_slice[1 + l_len as usize..1 + l_len as usize + r_len as usize]
            .copy_from_slice(&slice_right[0..r_len as usize]);
        self.vect
            .extend(main_slice[0..1 + l_len as usize + r_len as usize].into_iter());
    }
